...
export function Dice3D({ value, position, isRolling, onRollComplete }: DiceProps) {
...
export function DicePair({ dice1, dice2, isRolling, onRollComplete }: DicePairProps) {
